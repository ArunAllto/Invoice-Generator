 ...
 *
 * The Capacitor SQLite plugin needs a device or a browser, so these tests drive Node's built-in
 * `node:sqlite` instead.
 ...
 * check.
 *
 * What this cannot cover: the Capacitor plugin's API surface and its transaction wrapper.
